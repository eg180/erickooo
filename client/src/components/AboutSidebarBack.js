...
export default function AboutSidebarBack(props) {
    ...
    return (
        <StyledSidebar>
            ...
            <p>There's been a lot of trial-and-error in determining what I want to be 'when I grow up'. I studied economics, became interested in data analytics, and along the way, I found my love of writing instructions for computers to follow to make neat things. </p>
            ...
            <p>Currently, I'm in Atlanta, Georgia, but I will soon be living in Tours, France 🇫🇷, du coup, n'hésitez surtout pas à me contacter si vous cherchez quelqu'un qui ait des compétences avec la téchnologie et l'anglais / français !</p>
            <p></p>
